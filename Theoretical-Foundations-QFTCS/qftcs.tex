...
\fancypagestyle{plain}{\renewcommand{\headrulewidth}{0pt}\fancyhf{}\fancyfoot[RO,LE]{\thepage}}
...
\tcolorboxenvironment{theorem}{
  boxrule=0pt,
  boxsep=0pt,
  colback={white!90!magenta},
  enhanced jigsaw, 
  borderline west={2pt}{0pt}{magenta},
  sharp corners,
  before skip=10pt,
  after skip=10pt,
  breakable,
